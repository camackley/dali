...
export default Vue.extend({
  head(): any {
    const title = "Mackley Carmona | User-centered software engineer";
    const description = "Mackley Carmona a user-centered software engineer with 4+ years of experience in full-stack development.";
